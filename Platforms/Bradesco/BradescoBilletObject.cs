...
namespace PaymentCenter.Platforms.Bradesco
{
    ...
    class BradescoBilletObject
    {
        ...
        public string DataLimiteDesconto1 { get; private set; } = "0";
        ...
        /// 
        /// </summary>
        /// <param name="_nuCPFCNPJ"></param>
        /// <param name="_filialCPFCNPJ"></param>
        /// <param name="_ctrlCPFCNPJ"></param>
        /// <param name="_idProduto"></param>
        /// <param name="_nuNegociacao"></param>
        /// <param name="_dtEmissaoTitulo"></param>
        /// <param name="_dtVencimentoTitulo"></param>
        /// <param name="_vlNominalTitulo"></param>
        /// <param name="_cdEspecieTitulo"></param>
        /// <param name="_vlIOF"></param>
        /// <param name="_nomePagador"></param>
        /// <param name="_logradouroPagador"></param>
        /// <param name="_nuLogradouroPagador"></param>
        /// <param name="_complementoLogradouroPagador"></param>
        /// <param name="_cepPagador"></param>
        /// <param name="_complementoCepPagador"></param>
        /// <param name="_bairroPagador"></param>
        /// <param name="_municipioPagador"></param>
        /// <param name="_ufPagador"></param>
        /// <param name="_cdIndCpfcnpjPagador"></param>
        /// <param name="_nuCpfcnpjPagador"></param>
        /// <param name="_endEletronicoPagador"></param>
